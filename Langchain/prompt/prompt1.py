...
prompt = ChatPromptTemplate.from_messages([
    ("system", 
        ...
        *Available Functions:*
        - FindAllProducts(product_name:list | null , categories: list | null, price: str | null, discount: str | null): Finds all products in specified categories with optional price and discount filters.
        ...
        *Rules:*
        ...
        7. If the user asks for general help, details about Farm2Bag, or any non-product-related question, engage in a normal, helpful conversation.
